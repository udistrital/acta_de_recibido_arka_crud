...
func (m *AddCampoPersonaAsignadaEnTablaActaRecibido_20201229_093708) Up() {
    ...
    file, err := ioutil.ReadFile("../scripts/20201229_093708_add_campo_persona_asignada_en_tabla_acta_recibido_up.sql")
...
func (m *AddCampoPersonaAsignadaEnTablaActaRecibido_20201229_093708) Down() {
    ...
    file, err := ioutil.ReadFile("../scripts/20201229_093708_add_campo_persona_asignada_en_tabla_acta_recibido_down.sql")
